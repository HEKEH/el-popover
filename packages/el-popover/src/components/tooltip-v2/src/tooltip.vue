...
const arrowProps = reactive(pick(refedProps, keysOf(tooltipV2ArrowProps)));

const contentProps = reactive(pick(refedProps, keysOf(tooltipV2ContentProps)));

const rootProps = reactive(pick(refedProps, keysOf(tooltipV2RootProps)));

const triggerProps = reactive(pick(refedProps, keysOf(tooltipV2TriggerProps)));
</script>
